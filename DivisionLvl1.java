...
public class DivisionLvl1 extends Galaxy{
    public static int zahl1, zahl2, summe, sum2, sum3, sum4, a, b, counter;
    public DivisionLvl1(){
        zahl1 = (int) (Math.random()*10)+1;
        zahl2 = (int) (Math.random()*10)+1;
        summe = zahl1*zahl2;
        sum2 = zahl2 + (Greenfoot.getRandomNumber(10)-5);
        sum3 = zahl2 + (Greenfoot.getRandomNumber(10)-5);
        sum4 = zahl2 + (Greenfoot.getRandomNumber(10)-5);
        counter = 100;
        a = 7;
        b = 1;        
        
        showText(summe + " : " + zahl1, 500, 50);
