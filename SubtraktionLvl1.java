...
public class SubtraktionLvl1 extends Galaxy{
    public static int zahl1, zahl2, summe, sum2, sum3, sum4, a, b, counter;
    public SubtraktionLvl1(){
        zahl1 = (int) (Math.random()*(99)+1);
        zahl2 = (int) (Math.random()*(99)+1);
        summe = zahl1-zahl2;
        sum2 = summe + (Greenfoot.getRandomNumber(20)-10);
        sum3 = summe + (Greenfoot.getRandomNumber(20)-10);
        sum4 = summe + (Greenfoot.getRandomNumber(20)-10);
        counter = 100;
        a = (Greenfoot.getRandomNumber(10)+1);
        b = 1;            
        //  Verhindern dass die erste Zahl kleiner oder gleich die zweite Zahl ist
